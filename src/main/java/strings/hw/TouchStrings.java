...
public class TouchStrings {
    public static void main(String[] args) {
        ...
        System.out.println(str.startsWith(str, 4));
        System.out.println("Сравним наши строки = " + str.equals(str2));
        ...
        System.out.println("Каноническое представление строки - " + str.intern());
